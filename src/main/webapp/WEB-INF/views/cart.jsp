...
<div class="container" >
    <div>
    	<form:form  name="clearForm"  method="delete">  
            <button onclick="clearCart()"  class="btn btn-danger pull-left">삭제하기</button> 
        </form:form >
    ...
    <div style="padding-top: 50px">
        ...
        <tr>
            ...
            <td> <button type="button" onclick="removeFromCart('../cart/remove/${item.value.book.bookId}')"  class="badge badge-danger">삭제</button></td>
        </tr>
        </c:forEach>
        </form:form>
        <tr>
