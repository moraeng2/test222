...
<div class="container">
    <div class="row">
        <div class="col-md-4">
            <img src="<c:url value="/upload/${book.fileName}"></c:url>" alt="image"  style = "width:100%"/>
        </div>
        <div class="col-md-7">
            <form:form modelAttribute = "updateBook" action="./update" class="form-horizontal"  enctype="multipart/form-data" >  
